...
anyone on your way up: half of Gear Island is empty, but the half below you is a
giant factory city!
...
factory. To do this, you need to minimize heat loss while choosing a route that doesn't
require the crucible to go in a straight line for too long.
...
if the crucible enters that block. The starting point, the lava pool, is the top-left
city block; the destination, the machine parts factory, is the bottom-right city
block. (Because you already start in the top-left block, you don't incur that block's
...
turn 90 degrees left or right. The crucible also can't reverse direction; after entering
...
more than three consecutive blocks in the same direction, what is the least heat
loss it can incur?

*/

export module Puzzle2023:D17;

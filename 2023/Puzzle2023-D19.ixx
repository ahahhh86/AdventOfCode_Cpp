...
or reject the part. Each workflow has a name and contains a list of rules; each rule
...
of 1 to a maximum of 4000. Of all possible distinct combinations of ratings, your
job is to figure out which ones will be accepted.
...
you to sort is no longer relevant. How many distinct combinations of ratings will
be accepted by the Elves' workflows?

*/

export module Puzzle2023:D19;

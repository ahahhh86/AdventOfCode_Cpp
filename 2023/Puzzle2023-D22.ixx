...
sand to filter water, some of the bricks will need to be broken apart - nay, disintegrated
...
directly downward. Don't actually disintegrate any bricks - just determine what would
happen if, for each brick, only that brick were disintegrated. Bricks can be disintegrated
even if they're completely surrounded by other bricks; you can squeeze between bricks
if you need to.
...
disintegrating a single brick; how many bricks could be safely chosen as the one

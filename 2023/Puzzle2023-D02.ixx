...
pile of leaves. It's quite cold, but you don't see much snow. An Elf runs over to
greet you.
...
color in the bag, and your goal is to figure out information about the number of
cubes.
...
a semicolon-separated list of subsets of cubes that were revealed from the bag (like
...
Again consider the example games from earlier:
	...
	6 blue cubes. If any color had even one fewer cube, the game would have been impossible.
...
export module Puzzle2023:D02;

namespace AOC::Y2023::D02 {

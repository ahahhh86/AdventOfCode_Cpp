...
it hard to even get there. Normally, they use big machines to move the rocks and
filter the sand, but the machines have broken down because Desert Island recently
...
however, then move on to considering the second card in each hand. If they differ,
the hand with the higher second card wins; otherwise, continue with the third card
...
77888 is stronger because its third card is stronger (and both hands have the same
...
Your puzzle answer was 252052080.
...
Your puzzle answer was 252898370.
*/

export module Puzzle2023:D07;

namespace AOC::Y2023::D07 {

...
You reach the place where all of the mirrors were pointing: a massive parabolic reflector
dish attached to the side of another large mountain.
...
will stay in place. You note the positions of all of the empty spaces (.) and rocks
...
is on. (Cube-shaped rocks (#) don't contribute to load.) So, the amount of load caused
...
do that, you'll need to move the rocks to the edges of the platform. Fortunately,
a button on the side of the control panel labeled "spin cycle" attempts to do just
that!
...
export module Puzzle2023:D14;

namespace AOC::Y2023::D14 {

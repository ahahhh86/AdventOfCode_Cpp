...
then "right" would be east, and so on. Each trench is also listed with the color
...
just the edge of the lagoon; the next step is to dig out the interior so that it
is one meter deep as well:
	#######
	#######
	#######
	..#####

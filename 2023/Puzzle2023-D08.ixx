...
had the camel follow the instructions, but you've barely left your starting position.
...
you were a ghost, you'd probably just start at every node that ends with A and follow
...
you follow each left/right instruction, use that instruction to simultaneously navigate
away from both nodes you're currently on. Repeat this process until all of the nodes
you're currently on end with Z. (If only some of the nodes you're on end with Z,
they act like any other node and you continue as normal.) In this example, you would
proceed as follows:
...
export module Puzzle2023:D08;

namespace AOC::Y2023::D08 { // TODO: solve part 2, 2.147.483.647 too low, takes too long

...
6. Because the vertical line is not perfectly in the middle of the pattern, part
of the pattern (column 1) has nowhere to reflect onto and can be ignored; every other
...
You resume walking through the valley of mirrors and - SMACK! - run directly into
one. Hopefully nobody was watching, because that must have been pretty embarrassing.
...
In the second pattern, the smudge can be fixed by changing the fifth symbol on row
2 from . to #:
	1v#...##..#v1
	2^#...##..#^2
	3 ..##..### 3
...
Now, the pattern has a different horizontal line of reflection between rows 1 and
2.
...
the second pattern's new horizontal line has 1 row above it, summarizing to the value
400.
...
export module Puzzle2023:D13;

namespace AOC::Y2023::D13 {

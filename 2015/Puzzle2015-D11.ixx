...
the rightmost letter one step; if it was z, it wraps around to a, and repeat with
...
Given Santa's current password (your puzzle input), what should his next password
be?
...
export module Puzzle2015:D11;

namespace AOC::Y2015::D11 {

...
AND y -> z means to connect wires x and y to an AND gate, and then connect its output
to wire z.
...
For example:
	...
	p LSHIFT 2 -> q means that the value from wire p is left-shifted by 2 and then
		provided to wire q.
	NOT e -> f means that the bitwise complement of the value from wire e is provided
		to wire f.
...
export module Puzzle2015:D07;

namespace AOC::Y2015::D07 {

...
He sends them down a street with infinite houses numbered sequentially: 1, 2, 3,
4, 5, and so on.

Each Elf is assigned a number, too, and delivers presents to houses based on that
number:
...
10 = 10 presents. The fourth house gets 70 presents, because it is visited by Elves
